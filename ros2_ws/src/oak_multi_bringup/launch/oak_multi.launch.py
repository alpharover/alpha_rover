...
def generate_launch_description():
    ...
    default_params = os.path.join(pkg_share, 'config', 'oak_multi.yaml')
    params_file = LaunchConfiguration('params_file')

    container = ComposableNodeContainer(
        name='oak_multi_container',
        namespace='',
        package='rclcpp_components',
        executable='component_container',  # single-threaded to avoid MT double-free
        output='screen',
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description='Path to the YAML file with per-camera parameters.'
        ),
        container,
